<?php
/**
 * CreateFieldRequestAnyOf3Options
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateFieldRequestAnyOf3Options Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class CreateFieldRequestAnyOf3Options implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_field_request_anyOf_3_options';
    ...
    public const ICON_X_CHECKBOX = 'xCheckbox';
    ...
    */
     ...
     * Sets icon
     *
     * @param string $icon The icon name of the checkbox.
     *
     * @return self
     */
