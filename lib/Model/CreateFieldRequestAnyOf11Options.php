<?php
/**
 * CreateFieldRequestAnyOf11Options
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateFieldRequestAnyOf11Options Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class CreateFieldRequestAnyOf11Options implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_field_request_anyOf_11_options';
    ...
    */
     ...
     * Sets precision
     *
     * @param float $precision Indicates the number of digits shown to the right of the decimal point for this field. (0-8 inclusive)
     *
     * @return self
     */
