...
/**
 * CreateAuditLogRequestRequest Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class CreateAuditLogRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_audit_log_request_request';
    ...
    */
     ...
     * Sets filter
     *
     * @param string|null $filter An optional filter may be supplied. The filter value may be any of:  - User ID - Workspace ID - Base ID - Table ID - IPv4 address (**1.2.3.4**)
     *
     * @return self
     */
     ...
     * Sets time_period
     *
     * @param string $time_period The time period (specific month or day) for which you want to retrieve audit logs for. Must be in either **YYYY-MM** or **YYYY-MM-DD** format and within the last 180 days.
     *
     * @return self
     */
