...
/**
 * AuditLogEvents200ResponsePagination Class Doc Comment
 *
 * @category Class
 * @description Contains pagination tokens (if existing).
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AuditLogEvents200ResponsePagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'audit_log_events_200_response_pagination';
    ...
    */
     ...
     * Sets previous
     *
     * @param string $previous Pagination token used to retrieve the next-oldest page of available items. This value will be non-null in the response only if there exist any older items to retrieve. To retrieve the next-oldest page of available items, repeat the request that generated _this_ page of items, but supply this value as the **previous** query parameter.
     *
     * @return self
     */
