...
/**
 * ManageUserBatchedRequestUsersInner Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class ManageUserBatchedRequestUsersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'manage_user_batched_request_users_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id A user ID
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state [provisioned](/api/org-management-glossary#provisioned-user) | [deactivated](/api/org-management-glossary#deactivated-user) Can only change the state of [managed](/api/org-management-glossary#managed-user) users.
     *
     * @return self
     */
