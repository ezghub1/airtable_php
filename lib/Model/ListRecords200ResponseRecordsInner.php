...
/**
 * ListRecords200ResponseRecordsInner Class Doc Comment
 *
 * @category Class
 * @description A single record with field and cell values
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ListRecords200ResponseRecordsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'list_records_200_response_records_inner';
    ...
    protected static $openAPITypes = [
        'comment_count' => 'float',
        'created_time' => 'string',
        'fields' => 'array<string,mixed>', //it already return string or array or null
        'id' => 'string'
    ];
    ...
    */
     ...
     * Sets comment_count
     *
     * @param float|null $comment_count The number of comments (if there are any) on the record.  The `recordMetadata` query parameter must include `\"commentCount\"` in order to receive this.
     *
     * @return self
     */
