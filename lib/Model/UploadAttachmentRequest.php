...
/**
 * UploadAttachmentRequest Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class UploadAttachmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'upload_attachment_request';
    ...
    */
     ...
     * Sets content_type
     *
     * @param string $content_type Content type, e.g. \"image/jpeg\"
     *
     * @return self
     */
     ...
     * Sets file
     *
     * @param string $file The base64 encoded string of the file to be uploaded.
     *
     * @return self
     */
