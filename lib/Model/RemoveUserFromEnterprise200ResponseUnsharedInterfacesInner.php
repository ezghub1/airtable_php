<?php
/**
 * RemoveUserFromEnterprise200ResponseUnsharedInterfacesInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RemoveUserFromEnterprise200ResponseUnsharedInterfacesInner Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class RemoveUserFromEnterprise200ResponseUnsharedInterfacesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'remove_user_from_enterprise_200_response_unshared_interfaces_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('interface_name', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['interface_name'] === null) {
            $invalidProperties[] = "'interface_name' can't be null";
        }
    ...
    {
        if (is_null($interface_name)) {
            throw new \InvalidArgumentException('non-nullable interface_name cannot be null');
        }
