...
/**
 * UserMentioned Class Doc Comment
 *
 * @category Class
 * @description The user, or user group, mentioned and returned from the comments API
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UserMentioned implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User-mentioned';
