...
class InviteLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Invite-link';
    ...
    */
    ...
    public function setInvitedEmail($invited_email)
    {
        if (is_null($invited_email)) {
            array_push($this->openAPINullablesSetToNull, 'invited_email');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('invited_email', $nullablesSetToNull);
            if ($index !== FALSE) {
