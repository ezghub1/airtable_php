...
/**
 * AuditLogAnyOf1 Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class AuditLogAnyOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Audit_log_anyOf_1';
    ...
    */
     ...
     * Sets state
     *
     * @param string $state There was an error while attempting to process the audit log request. Refer to the error message and try again.
     *
     * @return self
     */
