...
/**
 * PutScimGroupRequest Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class PutScimGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'put_scim_group_request';
    ...
    */
     ...
     * Sets display_name
     *
     * @param string|null $display_name Becomes the displayName of the group in Airtable. It must not be in use already.
     *
     * @return self
     */
