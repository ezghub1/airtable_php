<?php
/**
 * PatchScimGroupRequestOperationsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PatchScimGroupRequestOperationsInner Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class PatchScimGroupRequestOperationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patch_scim_group_request_Operations_inner';
    ...
    */
     ...
     * Sets path
     *
     * @param string $path Path for a [SCIM group](https://airtable.com/api/enterprise#scimGroupFieldTypes) field.
     *
     * @return self
     */
