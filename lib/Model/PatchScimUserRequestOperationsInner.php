<?php
/**
 * PatchScimUserRequestOperationsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PatchScimUserRequestOperationsInner Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class PatchScimUserRequestOperationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patch_scim_user_request_Operations_inner';
    ...
    */
     ...
     * Sets path
     *
     * @param string $path Path for a [SCIM user](/api/scim-overview#scim-user-objects) field.
     *
     * @return self
     */
