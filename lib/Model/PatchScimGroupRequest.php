...
/**
 * PatchScimGroupRequest Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class PatchScimGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patch_scim_group_request';
    ...
    protected static $openAPITypes = [
        'operations' => '\Ez128\Airtable\Model\PatchScimGroupRequestOperationsInner[]',
        'schemas' => 'string[]'
    ];
    ...
    */
     ...
     * Gets operations
     *
     * @return \Ez128\Airtable\Model\PatchScimGroupRequestOperationsInner[]
     */
     ...
     * Sets operations
     *
     * @param \Ez128\Airtable\Model\PatchScimGroupRequestOperationsInner[] $operations A list of SCIM patch operations to perform.  See the [SCIM PATCH protocol](https://datatracker.ietf.org/doc/html/rfc7644#section-3.5.2) for details.
     *
     * @return self
     */
     ...
     * Sets schemas
     *
     * @param string[] $schemas A list of schemas, including at least SCIM's PatchOp schema URI.
     *
     * @return self
     */
