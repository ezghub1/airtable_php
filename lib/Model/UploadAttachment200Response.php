...
/**
 * UploadAttachment200Response Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class UploadAttachment200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'upload_attachment_200_response';
    ...
    */
     ...
     * Sets fields
     *
     * @param array<string,mixed> $fields Cell values are keyed by field ID.  See [Cell Values](/api/field-model) for more information on cell value response types.
     *
     * @return self
     */
