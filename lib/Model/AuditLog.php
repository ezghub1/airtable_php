 ...
 *
 * @category Class
 * @description A single \&quot;audit log task\&quot;.  The keys common to all response types are &#x60;id&#x60;, &#x60;createdByUserId&#x60;, &#x60;createdTime&#x60;, &#x60;timePeriod&#x60;, &#x60;filter&#x60;
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class AuditLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Audit-log';
    ...
    protected static $openAPITypes = [
        ...
        'data' => '\Ez128\Airtable\Model\AuditLogAnyOf2Data'
    ];
    ...
    */
     ...
     * Sets filter
     *
     * @param string|null $filter Filter specified in the [creation request](/api/create-audit-log-request).
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string $state The audit log request is done processing. Download the files in **data.logFileUrls**. The gzipped files contain newline-delimited JSON log entries.  `data` is uniquely provided with the `done` state
     *
     * @return self
     */
     ...
     * Sets time_period
     *
     * @param string $time_period Either YYYY-MM or YYYY-MM-DD, as specified in the [creation request](/api/create-audit-log-request).
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string $error_message An error message explaining what went wrong while processing the request.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \Ez128\Airtable\Model\AuditLogAnyOf2Data
     */
     ...
     * Sets data
     *
     * @param \Ez128\Airtable\Model\AuditLogAnyOf2Data $data data
     *
     * @return self
     */
