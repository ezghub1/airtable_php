<?php
/**
 * CreateFieldRequestAnyOf14Options
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateFieldRequestAnyOf14Options Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class CreateFieldRequestAnyOf14Options implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_field_request_anyOf_14_options';
    ...
    public const DURATION_FORMAT_H_MM_SS_S = 'h:mm:ss.S';
    public const DURATION_FORMAT_H_MM_SS_SS = 'h:mm:ss.SS';
    public const DURATION_FORMAT_H_MM_SS_SSS = 'h:mm:ss.SSS';
    ...
    public function getDurationFormatAllowableValues()
    {
        return [
            ...
            self::DURATION_FORMAT_H_MM_SS_S,
            self::DURATION_FORMAT_H_MM_SS_SS,
            self::DURATION_FORMAT_H_MM_SS_SSS,
        ];
    }
    ...
    */
     ...
     *
     * @param string $duration_format duration_format
     *
     * @return self
     */
