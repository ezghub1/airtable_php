<?php
/**
 * GetEnterprise200ResponseAggregated
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetEnterprise200ResponseAggregated Class Doc Comment
 *
 * @category Class
 * @description The aggregated values across the enterprise account and its descendants. Only returned when the enterprise account has the Enterprise Hub feature enabled.
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetEnterprise200ResponseAggregated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_enterprise_200_response_aggregated';
    ...
    */
     ...
     * Sets group_ids
     *
     * @param string[] $group_ids A list of groups that belong to the enterprise account and its descendants.
     *
     * @return self
     */
     ...
     * Sets user_ids
     *
     * @param string[] $user_ids A list of users including all the collaborators with the enterprise account and its descendants.
     *
     * @return self
     */
     ...
     * Sets workspace_ids
     *
     * @param string[] $workspace_ids A list of workspaces that are managed by the enterprise account and its descendants.
     *
     * @return self
     */
