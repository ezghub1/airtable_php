...
/**
 * AuditLogAnyOf Class Doc Comment
 *
 * @category Class
 * @package  Ez128\Airtable
 * @author   OpenAPI Generator team
 ...
 */
class AuditLogAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Audit_log_anyOf';
    ...
    */
     ...
     * Sets state
     *
     * @param string $state The audit log request has not started processing or is being processed. Check again in a few minutes.
     *
     * @return self
     */
